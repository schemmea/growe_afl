...
#./scripts/run_jqf_script_debug.sh /c/Users/Alena/source/repos/JQF-jqf-1.9/scripts/jqf-driver.sh /c/Users/Alena/source/repos/demo2/build/libs/demo2-1.0-SNAPSHOT-all.jar
# argument checking
if [ $# -ne 2 ]; then
